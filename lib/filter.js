...
const Condition = class {
  ...
  get queryInstagram() {
    ...
    } else if (this._field === 'place') {
      // to be replaced by geo-coordinate match
      return {'info.location.title': new RegExp(this._value, 'i')}
    }
  }
  ...
  get queryTwitter() {
    if (this._field === 'keyword'){
      ...
      return {'place.name': new RegExp(this._value, 'i')}
    }
  }
}
